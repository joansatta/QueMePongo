...
public class PrendaSuperiorFactory implements PrendaFactory {

	public Prenda crearPrenda(Material material, Tipo tipo, Color colorPrimario) {
		return new Prenda(CategoriaEnum.ParteSuperior,material,tipo,colorPrimario,null);
	}

	public Prenda crearPrenda(Material material, Tipo tipo, Color colorPrimario, Color colorSecundario) {
		return new Prenda(CategoriaEnum.ParteSuperior,material,tipo,colorPrimario,colorSecundario);
	}
